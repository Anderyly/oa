...
class Backup
{
    ...
    //备份数据表
    public static function backup($config = array())
    {
        //首次执行时没有备份状态
        if (!Q("get.status")) {
            F('backupDir', null);
    ...
    //备份表结构
    private static function backup_structure()
    {
    ...
    //写入备份数据
    private static function write_backup_data($table, $data, $current_row)
    {
        //当前备份分卷id
     ...
     * @return array
     */
    private static function next_backup($table)
    {
